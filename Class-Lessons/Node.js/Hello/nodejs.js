...
//var mySeason = require('./seasnos');
var myCLassWork = require('./classwork')
...
http.createServer(function (req,res){
    ...
    res.write(mySeason.seasonName(query.season));
    res.write('<hr/>');
    //get queries (holyday)
    res.write(mySeason.holiday(query.holiday));*/
    var query = url.parse(req.url,true).query;
    res.write(myCLassWork.firstName(query.firstName));
    res.write(myCLassWork.familyName(query.faName));
    res.write(myCLassWork.city(query.cityName));
    res.write(myCLassWork.friend(query.friendName));
    //סגירת תקשורת
    res.end();
